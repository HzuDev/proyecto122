      ...
      <>
        ...
        <section className="bg-transparent py-14">
          <div className="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
            ...
            <div className="mt-8 [column-fill:_balance] sm:columns-2 sm:gap-6 lg:columns-3 lg:gap-8 py-14">
              <div className="mb-8 sm:break-inside-avoid">
                <blockquote className="rounded-lg bg-gradient-to-r from-indigo-900 via-indigo-800 to-blue-750  p-6 shadow-sm sm:p-8">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="mt-0.5 text-lg font-medium text-gray-100">Paul Starr</p>
                    </div>
                  </div>
              ...
              <div className="mb-8 sm:break-inside-avoid">
                <blockquote className="rounded-lg bg-gradient-to-r  from-indigo-900 via-indigo-800 to-blue-750  from-primary-500 to-secondary-500 p-6 shadow-sm sm:p-8">
                  <div className="flex items-center gap-4">
                    <img
                      alt="Man"
                      src="https://images.unsplash.com/photo-1595152772835-219674b2a8a6?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1180&q=80"
